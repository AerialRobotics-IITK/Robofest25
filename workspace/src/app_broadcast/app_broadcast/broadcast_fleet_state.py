...
class FleetStateNode(Node):
    ...
    def __init__(self):
        ...
        self.drones = {
            1: {"x": 0.0, "y": 0.0, "battery":"100%"},
            2: {"x": 0.0, "y": 0.0, "battery":"100%"},
            3: {"x": 0.0, "y": 0.0, "battery":"100%"},
            4: {"x": 0.0, "y": 0.0, "battery":"100%"},
        }
    ...
    def drone_callback(self, msg, drone_id):
        ...
        self.drones[drone_id]["x"] = msg.pose.pose.position.x
        self.drones[drone_id]["y"] = msg.pose.pose.position.y
